  ...
  return (
    <form onSubmit={submit} className="space-y-5">
      <div className="grid gap-4 sm:grid-cols-2">
        <div>
          <label htmlFor="firstName" className="text-sm font-medium text-ink-900">
            Prénom
          </label>
          <input
            id="firstName"
        ...
        <div>
          <label htmlFor="lastName" className="text-sm font-medium text-ink-900">
            Nom
          </label>
          <input
            id="lastName"
      ...
      <Button type="submit" size="lg" loading={pending} disabled={pending} className="w-full">
        Créer mon compte
      </Button>
    </form>
  );
